...
//  const artifactTemplates = "transaction-counts"
//  const getLocalEntryCmdLiteral = "transaction-counts"

//  var getLocalEntryCmd = &cobra.Command{
// 	 Use:     getLocalEntryCmdLiteral,
// 	 Short:   generateGetCmdShortDescForArtifact(),
// 	 Long:    generateGetCmdLongDescForArtifact(, ""),
// 	 Example: generateGetCmdExamplesForArtifact(, getTrimmedCmdLiteral(), ""),
...
// 	 getLocalEntryCmd.Flags().StringVarP(&getLocalEntryCmdFormat, "format", "", "", generateFormatFlagUsage())
// 	 getLocalEntryCmd.MarkFlagRequired("environment")
//  }

//  func handleGetLocalEntryCmdArguments(args []string) {
// 	 utils.Logln(utils.LogPrefixInfo + "get LocalEntrys called")
