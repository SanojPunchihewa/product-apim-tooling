...
const getCmdLongDesc = `Get information about artifacts deployed in a Micro Integrator instance in a given environment specified by flag (--environment, -e)`

const getCmdExamples = utils.ProjectName + ` ` + utils.MiCmdLiteral + ` ` + GetCmdLiteral + ` ` + `integrationapis` + ` -e dev
