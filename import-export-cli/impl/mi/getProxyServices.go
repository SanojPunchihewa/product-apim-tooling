...
func GetProxyServiceList(cred credentials.MiCredential, env string) (*artifactutils.ProxyServiceList, error) {
...
func GetProxyService(cred credentials.MiCredential, env, proxyName string) (*artifactutils.Proxy, error) {
...
func PrintProxyServiceDetails(proxy *artifactutils.Proxy, format string) {
	...
	renderer := getItemRenderer(proxy)
